...
const ManageDoctorsPage = () => {
  ...
  const handleAddDoctor = async (e) => {
    ...
    try {
      await api.clinic.addUser(formData.clinicId, formData.userId, 'doctor', ['view_queue', 'manage_queue']);
    ...
    <Layout role="admin">
      <div className="dashboard-header">
        <div>
          ...
          <p style={{
            ...
            Assign doctors to your clinics.
          </p>
        </div>
      </div>
      ...
      <div className="dashboard-grid-2-1">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <Card>
            <h3 style={{ fontSize: '1.25rem', marginBottom: '1.5rem', color: theme === 'light' ? '#0f172a' : '#f1f5f9' }}>Add New Doctor</h3>
            ...
            <form onSubmit={handleAddDoctor} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div>
                ...
                <Input
                  placeholder="Enter User ID of the doctor"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <Card>
            <h3 style={{ fontSize: '1.125rem', marginBottom: '1rem', color: theme === 'light' ? '#0f172a' : '#f1f5f9' }}>Doctor Privileges</h3>
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start', marginBottom: '1rem' }}>
              <Stethoscope size={20} color="var(--primary-500)" style={{ marginTop: '0.25rem' }} />
              <div>
                <p style={{ fontWeight: 600 }}>Consultations</p>
                <p style={{ fontSize: '0.875rem', opacity: 0.8 }}>Can view assigned patients and manage their queue.</p>
              </div>
            </div>
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              <Activity size={20} color="var(--primary-500)" style={{ marginTop: '0.25rem' }} />
              <div>
                <p style={{ fontWeight: 600 }}>Records</p>
                <p style={{ fontSize: '0.875rem', opacity: 0.8 }}>Can view and update patient medical records.</p>
              </div>
            </div>
          </Card>
        </div>
