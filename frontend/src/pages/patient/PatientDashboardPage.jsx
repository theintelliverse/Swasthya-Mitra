    ...
    <Layout role="patient">
      <div style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <h1 style={{ 
            fontSize: '1.875rem', 
            marginBottom: '0.5rem',
            color: theme === 'light' ? '#0f172a' : '#e0e7ff'
          }}>Hello, Rajesh</h1>
          <p style={{ color: theme === 'light' ? '#1e293b' : '#c7d2e0' }}>Manage your health and appointments.</p>
        </div>
        <Button>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <h3 style={{ fontSize: '1.25rem', fontWeight: 600, color: theme === 'light' ? '#0f172a' : '#e0e7ff' }}>Health Records</h3>
          <Card>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem', borderBottom: '1px solid var(--slate-100)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontWeight: 600, color: theme === 'light' ? '#0f172a' : '#e0e7ff' }}>Blood Test Report</p>
                  <p style={{ fontSize: '0.875rem', color: theme === 'light' ? '#1e293b' : '#cbd5e1' }}>12 Oct, 2023 • Dr. Sharma</p>
                </div>
              </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  <p style={{ fontWeight: 600, color: theme === 'light' ? '#0f172a' : '#e0e7ff' }}>Prescription - Fever</p>
                  <p style={{ fontSize: '0.875rem', color: theme === 'light' ? '#1e293b' : '#cbd5e1' }}>05 Sep, 2023 • Dr. Anjali</p>
                </div>
              </div>
              <Button variant="ghost" size="sm">View</Button>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <Card>
            <h3 style={{ fontSize: '1.125rem', marginBottom: '1rem', color: theme === 'light' ? '#0f172a' : '#e0e7ff' }}>Health Vitals</h3>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div style={{ padding: '1rem', backgroundColor: theme === 'light' ? '#f8fafc' : 'rgba(51, 65, 85, 0.5)', borderRadius: 'var(--radius-md)' }}>
                <p style={{ fontSize: '0.75rem', color: theme === 'light' ? '#64748b' : '#94a3b8' }}>Blood Pressure</p>
                <p style={{ fontSize: '1.125rem', fontWeight: 600, color: theme === 'light' ? '#0f172a' : '#f1f5f9' }}>120/80</p>
              </div>
              <div style={{ padding: '1rem', backgroundColor: theme === 'light' ? '#f8fafc' : 'rgba(51, 65, 85, 0.5)', borderRadius: 'var(--radius-md)' }}>
                <p style={{ fontSize: '0.75rem', color: theme === 'light' ? '#64748b' : '#94a3b8' }}>Heart Rate</p>
                <p style={{ fontSize: '1.125rem', fontWeight: 600, color: theme === 'light' ? '#0f172a' : '#f1f5f9' }}>72 bpm</p>
              </div>
              <div style={{ padding: '1rem', backgroundColor: theme === 'light' ? '#f8fafc' : 'rgba(51, 65, 85, 0.5)', borderRadius: 'var(--radius-md)' }}>
                <p style={{ fontSize: '0.75rem', color: theme === 'light' ? '#64748b' : '#94a3b8' }}>Weight</p>
                <p style={{ fontSize: '1.125rem', fontWeight: 600, color: theme === 'light' ? '#0f172a' : '#f1f5f9' }}>70 kg</p>
              </div>
              <div style={{ padding: '1rem', backgroundColor: theme === 'light' ? '#f8fafc' : 'rgba(51, 65, 85, 0.5)', borderRadius: 'var(--radius-md)' }}>
                <p style={{ fontSize: '0.75rem', color: theme === 'light' ? '#64748b' : '#94a3b8' }}>Height</p>
